...
<%
	...
	try{
		numLinea=Integer.parseInt(linea);
	}catch(Exception e){
	...
	<div class="row">
		...
		<div class="col-lg-8 col-md-10 bg-info">
			...
			<table class="table table-striped">
				...
				<%
					String query = "select paradas_idparadas,paradasiguiente, paradas.desc from l_p join paradas on (idparadas=paradas_idparadas) where lineas_idlineas="
							+ linea + " order by idparadas desc";
				...
				<%
						...
						<h3> El valor introducido no es válido para la consulta</h3>
						<%
					}
				%>
			</table>
