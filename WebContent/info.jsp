...
<nav class="navbar navbar-expand-sm bg-info navbar-light"> <!-- Brand/logo -->
	...
	<div class="row">
		...
		<h3>BUSSAM</h3>
		<p>Buses Urbanos SistemaS de Asistencia Municipal (BUSSAM) es la empresa encargada de gestionar el servicio de autobuses y Tranvias urbanos de la ciudad de Villalta de Abajo.</p>
		<p>El coste del billete univiaje es 1.50$. Si posee bono cada validación descontará 0.7$ de su saldo </p>
		<p>En el caso de jubilados el viaje es gratuito mostrando la tarjeta de la tercera edad. </p>
