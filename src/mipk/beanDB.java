...
public class beanDB {
	   ...
	   //----- Metodo que realiza la conexion a la BD
		public void conectarBD() throws SQLException
		{
	        try{
	            ...
	            cn=DriverManager.getConnection("jdbc:mysql://159.65.123.70/bussam","hefesto","vulcanodb");
	    ...
	    public  String[] resConsultaSelect(String selec, int numcol) throws SQLException
	   {
	    ...
	    public  String[][] resConsultaLineas(String selec) throws SQLException
		   {
		    Statement stmt=null;
		    ResultSet rs=null;
		    String[][] result=null;
	    ...
	    public  String[][] resConsulta(String selec) throws SQLException
		   {
		    Statement stmt=null;
		    ResultSet rs=null;
		    String[][] result=null;
